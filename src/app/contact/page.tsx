          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-navy-900 rounded-2xl p-8 text-white">
                <h2 className="font-display font-bold text-xl mb-6">Direct Contact</h2>
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-white group-hover:text-gold-300 transition-colors text-sm">{profile.email}</div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      <div className="text-xs text-gray-400 uppercase tracking-wider mb-1">Phone / WhatsApp</div>
                      <div className="text-white group-hover:text-gold-300 transition-colors text-sm">{profile.phone}</div>
                    </div>
                  </a>
                  <a
